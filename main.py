...
def load_data(data_path: str) -> pd.DataFrame:
    ...
    additional_fields_json = get_additional_fields_json(df_train_val)

    year_manufactured = get_series_from_additional_fields_json(
        'yearManufactured')
    year_manufactured, year_manufactured_mean, year_manufactured_std = z_score(year_manufactured)
